                    ...
                    {foreach from=$info item="server" key="name"}
                        {if $server['gq_hostname'] != ""}
                            <tr style="border-color:red;">
                                ...
                                <td id="address" class="loading last" style="vertical-align:middle;text-align:center;background-color:rgba(0,0,0,0.3); color:white;min-width:150px;">{$server['gq_hostname']}</td>
                                <td id="map" class="loading last" style="vertical-align:middle;text-align:center;background-color:rgba(0,0,0,0.3);color:white;min-width:150px;">{$server['gq_mapname']}</td>
